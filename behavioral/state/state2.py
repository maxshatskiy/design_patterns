"""Example 2 from Wessel Badenhorst."""
...
class StateMachine(object):
    ...
    def action(self, in_key):
        """changes state in which state machine is self.state_machine.state = self.state_machine.mapping[in_key]"""
